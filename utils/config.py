...
def get_args():
    ...
    parser.add_argument('--redd_location', type=str, default=r'/root/autodl-tmp/ELECTRIcity/data/raw/REDD/REDD')
    parser.add_argument('--ukdale_location', type=str, default=r'/root/autodl-tmp/ELECTRIcity/data/raw/UK_Dale')
    ...
    os.makedirs(os.path.join(current_dir, '..', 'data', 'raw', 'REDD'), exist_ok=True)
    os.makedirs(os.path.join(current_dir, '..', 'data', 'raw', 'UK_Dale'), exist_ok=True)
    os.makedirs(os.path.join(current_dir, '..', 'data', 'raw', 'Refit', 'Data'), exist_ok=True)
    os.makedirs(os.path.join(current_dir, '..', 'data', 'raw', 'Refit', 'Labels'), exist_ok=True)
    os.makedirs(os.path.join(current_dir, '..', 'data', 'processed'), exist_ok=True)
    os.makedirs(os.path.join(current_dir, '..', args.export_root), exist_ok=True)
